...
theorem PreservesDispatch.lensRenameStmt
  ...
  | branch f q₁ q₂ ih₁ ih₂ =>
      ...
      · simpa only [Lax20Proofs.RamToTM.lensRenameStmt, TM2.stepAux, h] using
          ih₂ state tapes
      · simpa only [Lax20Proofs.RamToTM.lensRenameStmt, TM2.stepAux, h] using
          ih₁ state tapes
  | goto f => rfl
...
theorem PreservesDispatch.lensPhaseLeft
  ...
  unfold Lax20Proofs.RamToTM.lensPhaseLeft
  split
  · intro state tapes
    rfl
...
theorem ProgramPreservesDispatch.lensMultiPhaseLeft
  ...
  intro label
  unfold Lax20Proofs.RamToTM.lensMultiPhaseLeft
