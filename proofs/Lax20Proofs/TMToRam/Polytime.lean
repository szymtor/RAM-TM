...
open Lax20.BinaryWordEncoding Lax20.RamPolytime Lax20.TuringPolytime
...
theorem turingPolytime_to_ramPolytime {f : List ℕ → List ℕ}
  ...
  · intro a ha
    ...
    · rcases List.mem_cons.mp ha with rfl | ha
      · have hl := Lax20Proofs.Encoding.length_lt_two_pow_bitSize_add_one x
        exact hl.trans_le (pow_mono_exponent (by
          rw [hwordEval]
          simp [exponentPoly]
          omega))
      · have hv := Lax20Proofs.Encoding.mem_lt_two_pow_bitSize_add_one ha
