...
theorem computable_to_ramComputable {f : List ℕ → List ℕ}
    (hf : Computable f) :
    Lax51.TuringRamEquivalence.RamComputable f := by
...
namespace Lax51Proofs.TuringRamEquivalence

open Lax51.TuringRamEquivalence

/--
---
conclusion: Lax51.TuringRamEquivalence.ramComputable_iff_computable
---
...
theorem ramComputable_iff_computable (f : List ℕ → List ℕ) :
  ...
  constructor
  · exact Lax51Proofs.Computability.ramComputable_to_computable
  · exact Lax51Proofs.Computability.computable_to_ramComputable

end Lax51Proofs.TuringRamEquivalence
